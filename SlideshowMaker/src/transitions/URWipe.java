 ...
 * Class name: URWipe
 *
 * This class extends the abstract class "Transition" and is used to transition between images using a upward & left-to-right Wipe
 */

public class URWipe extends Transition {

    /**
     * Public constructor for URWipe. Sets m_type attribute from Transition abstract class to "URWipe"
     */
    public URWipe()
    {
        m_type = "URWipe";
    ...
    /**
     * Draws newImage in imgLabel using URWipe effect
     *
    ...
    public void doTrans(JLabel imgLabel, Image newImage)
    {
        ...
        for(int i=0; i<numIterations; i++)
        {
            ...
            gPan.drawImage(newImage, 0, imgHeight, bX, bY, 0, imgHeight, bX, bY,null); // Draw portion of newImage in imgLabel
